...
def test_shop_import_csv1(db_setup, tmpdir, cli):
    """1. import from csv"""
...
def test_shop_import_csv2(db_setup, tmpdir, cli):
...
def test_shop_import_csv3(db_setup, tmpdir, cli):
...
def test_shop_import_csv4(db_setup, cli, capsys):
...
def test_shop_import_csv6(db_setup, tmpdir, cli):
...
def test_shop_import_csv7(db_setup, tmpdir, cli):
